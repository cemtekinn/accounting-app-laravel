...
namespace Illuminate\Routing {
    ...
    class Router {
         ...
         * @param mixed $group
         * @param mixed $includeResources
         * @static 
         */
        public static function customResource($name, $controller, $group = null, $includeResources = true)
        {
            return \Illuminate\Routing\Router::customResource($name, $controller, $group, $includeResources);
        }
...
namespace Illuminate\Database\Query {
    ...
    class Builder {
        ...
        {
            return \Illuminate\Database\Query\Builder::getSql();
        }
